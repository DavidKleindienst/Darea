function [mainFigure, axesImage,axesZoom, hZoomText, hZoom, gridXPx, gridYPx,hX,hY] =...
            make2PanelWindow(title, image,imageName,scale,percentScreenUsed,imshrinkfactor,...
                            zoomshrinkfactor, defaults,createZoomFcn,moveZoomFcn,visible)
% Creates a main Figure with 2 Panels
% One panel for original Image, one for Zoom

[posXWindow,posYWindow,figureWidthPx,figureHeightPx,dispImageWidthPx,dispImageHeightPx,...

...
def test_tensorflow_installation():
    '''Checks if tensorflow installation works, whether a GPU is available 
    returns cpu, gpu
    ...
    if both  are true, tensorflow was installed properly and can use the gpu'''
    try:
...
if __name__=='__main__':
    ...
    if args.function=='test_install':
    	print('ASDf')
    	print(test_tensorflow_installation())

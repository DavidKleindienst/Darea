...
function h=drawEllipseFromPoints(points, LineStyle, LineWidth, Color, axes)
...
% |    X                       | 
% *----------------------X-----*  
% Afterwards, draws the ellipse surrounding the rectangle.
...
% Center
x0 = (rect(1,1)+rect(3,1))/2;
y0 = (rect(1,2)+rect(3,2))/2;
...
% Draws the ellipse
h=drawEllipse(x0, y0, majR+5, minR+5, angle,  LineStyle, LineWidth, Color, axes);
